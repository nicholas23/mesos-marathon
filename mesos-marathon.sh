...
#mesos slave
docker run -d --link zookeeper:zookeeper -v /sys/fs/cgroup:/sys/fs/cgroup -v /var/run/docker.sock:/var/run/docker.sock mesosphere/mesos:1.0.1-2.0.93.ubuntu1404 mesos-slave --master=zk://zookeeper:2181/mesos
docker run -d --link zookeeper:zookeeper -v /sys/fs/cgroup:/sys/fs/cgroup -v /var/run/docker.sock:/var/run/docker.sock mesosphere/mesos:1.0.1-2.0.93.ubuntu1404 mesos-slave --master=zk://zookeeper:2181/mesos
#marathon
